...
class UserAddShowView(TemplateView):
    ...
    def get_context_data(self, *args, **kwargs):    #Hamiley TemplateView ko method lai overwrite gareko ho .
        ...
        form = StudentRegistration()            # khali StudentRegistration form object create garera form variable ma rakheko...'form' is an object of 'StudentRegistration' Class
...
class UserEditView(View):
    ...
    def post(self, request, id):
        edit_record = User.objects.get(pk=id)
        form = StudentRegistration(request.POST, instance=edit_record)  # form ma paritcular user ko database batw data tanera tyo form ma display garauna 'instance' ko use huncha.
        if form.is_valid():
...
class UserDeleteView(RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):    #This method is given by 'RedirectView' so yeslai overrride gareko.
        ...
        get_id =  kwargs['id']  #kwargs dictionary ma {'id': id} yesari ayerako huncha so tyo 'id' key ko through value get gareko
